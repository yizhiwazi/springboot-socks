>序言：SpringBoot 近年来发展如火如荼，其正引领着快速开发的潮流，未来微服务是否能席卷全球我们不得而知，但值得兴奋和期待的是，相信在未来不久，SpringBoot 终将替代Spring 作为Web系统开发的门面标配。（注意：这里指的是替代，而不是取代，其实质关系：Spring <- SpringBoot <- SpringCloud <- 微服务）
